...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      rowAutoApproveAll: "Auto-pilot: approve everything",
    ...
    ko: {
      ...
      rowAutoApproveAll: "자동 조종: 모두 자동 승인",
    ...
    ja: {
      ...
      rowAutoApproveAll: "オートパイロット：すべて自動承認",
